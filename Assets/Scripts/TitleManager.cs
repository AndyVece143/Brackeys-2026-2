...
public class TitleManager : MonoBehaviour
{
    ...
    IEnumerator MoveElements(bool right)
    {
        ...
        Vector2 modeVector = new Vector2(controls.transform.position.x + moveAmount, 0);
        ...
        while (time < duration)
        {
            ...
            controls.gameObject.transform.position = Vector2.Lerp(controls.transform.position, modeVector, t);
